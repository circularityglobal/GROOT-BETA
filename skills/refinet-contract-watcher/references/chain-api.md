...
### chain_watchers
```sql
CREATE TABLE chain_watchers (
    id TEXT PRIMARY KEY,
    user_id TEXT NOT NULL REFERENCES users(id),
    chain TEXT NOT NULL,           -- ethereum, base, arbitrum, polygon
    contract_address TEXT NOT NULL,
    event_names TEXT,              -- JSON array of event signatures (null = all)
    rpc_url TEXT,                  -- custom RPC or use default
...
CREATE TABLE chain_events (
    ...
    decoded_data TEXT,             -- JSON: decoded event parameters
    raw_data TEXT,                 -- JSON: raw log data

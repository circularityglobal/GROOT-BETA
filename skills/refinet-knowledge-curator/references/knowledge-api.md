...
CREATE TABLE knowledge_documents (
    ...
    user_id TEXT,
    visibility TEXT DEFAULT 'platform',  -- private, public, platform
    tags TEXT,                   -- JSON array
    doc_type TEXT,               -- pdf, docx, xlsx, csv, txt, md, json, sol
    page_count INTEGER,
    metadata_json TEXT,
...
CREATE TABLE knowledge_chunks (
    ...
    embedding TEXT,              -- JSON-serialized 384-dim float array (NULL if not yet embedded)
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
```
